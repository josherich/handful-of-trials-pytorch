...
def main(env, ctrl_type, ctrl_args, overrides, iters, model_dir, logdir):
    ...
    overrides.append(["exp_cfg.exp_cfg.ntrain_iters", iters])
...
if __name__ == "__main__":
    ...
    main(args.env, "MPC", args.ctrl_arg, args.override, args.iters, args.model_dir, args.logdir)